...
parser.add_argument("--version", type=str, default='test_coco_lora', help="version of test lora")
...
parser.add_argument("--embedding_path", type=str, default='parameters/image/flickr8k/val/embeddings_{v_block}.pth', help="embeddings dir")
parser.add_argument("--result_path", type=str, default='./results/flickr8k_lora_val_nohead/R{k}', help="infer results dir")
parser.add_argument("--csv_file_path", type=str, default='test_flickr8k_lora_valset_nohead.csv', help="infer output csv path")
