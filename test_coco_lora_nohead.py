...
parser.add_argument("--lora_dir", type=str, default='/home/u2021010261/data/yx/Mobile-Search-Engine-main/.checkpoints/lora/coco/without_head/trunk_full/ratio3/e12', help="lora dir")
parser.add_argument("--embedding_path", type=str, default='parameters/image/coco/val/embeddings_{v_block}_without_head.pth', help="embeddings dir")
parser.add_argument("--result_path", type=str, default='./results/coco_lora_val_nohead', help="infer results dir")
parser.add_argument("--csv_file_path", type=str, default='test_coco_zeroshot_lora_valset_nohead.csv', help="infer output csv path")
