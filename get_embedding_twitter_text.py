...
parser.add_argument("--lora_dir", default='.checkpoints/lora/twitter/with_head/trunk/e50',type=str, help="Number of audio blocks")
parser.add_argument("--embedding_dir", default='parameters/image/twitter',type=str, help="Number of audio blocks")
parser.add_argument("--dataset", default='twitter',type=str, help="dataset")
