...
parser.add_argument("--version", default='e2e_twitter_nolora',type=str, help="gpu device id (if applicable)")
...
model_parameter=f'parameters/image/twitter/model/S={S}.pth'
