...
parser.add_argument("--version", default='flicker_figure_v1',type=str, help="gpu device id (if applicable)")
...
#save layers
layers_path=f"parameters/image/flickr8k/val/layers/N={N}_S={S}_v{version}.pkl"
...
K_list= [1,2,4,5,8,10,16,30,32,48]
