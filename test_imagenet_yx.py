...
lora_dir ='/data/yx/MobileSearchEngine/Mobile-Search-Engine-main/.checkpoints/lora/2--32/imagenet_2'
...
# Instantiate model
model = imagebind_model.imagebind_huge(pretrained=True,vision_num_blocks=2)
if lora:
    model.modality_trunks.update(
        LoRA.apply_lora_modality_trunks(model.modality_trunks, rank=4,
                                        layer_idxs={ ModalityType.VISION: [1]},
...
def run_inference(text_class):
    ...
    datadir = "/data/yx/dataset/imagenet"
    ...
    # np.savetxt('./results/t-result1.txt',counts)
