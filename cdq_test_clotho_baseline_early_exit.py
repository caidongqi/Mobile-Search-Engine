...
with open('/data/air/pc/Mobile-Search-Engine/results/clotho/R10/layers_min.txt', 'r') as file:
    lines = file.readlines()
    layers = np.array([int(line.strip()) for line in lines])
...
parser.add_argument('--bs', type=int, default=1, help='Batch size for testing')
