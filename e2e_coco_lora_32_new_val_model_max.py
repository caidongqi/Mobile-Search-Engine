...
parser.add_argument("--N", type=int, default=7, help="First get N embeddings")
parser.add_argument("--Q", default=10,type=int, help="Fine grained embedding scope after query")
parser.add_argument("--S", default=30,type=int, help="Grain for predict model, larger S, smaller average predicted layer")
...
parser.add_argument("--version", default='coco_figure_v4',type=str, help="gpu device id (if applicable)")
...
K_list=[1,2,4,5,8,10,16,20,30,32,48]
