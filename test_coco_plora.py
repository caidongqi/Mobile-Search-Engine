...
parser.add_argument("--vision_num_blocks", type=int,default=22, help="Number of vision blocks")
...
model = imagebind_model.imagebind_huge(pretrained=True,vision_num_blocks=vision_num_blocks+1)
...
# coco_annotation_file = "/home/u2021010261/share/pc/COCO/captions_train2017.json"
# data_dir="/home/u2021010261/share/pc/COCO/train2017"
...
coco_embedding_path=f'parameters/image/coco/embeddings_{v_block}_lora.pth'
import pandas as pd
def run_inference():    
    ...
    with torch.no_grad():
        ...
        for k in topk1:
            path=f'./results/coco_plora_val/R{k}'
    ...
    # # 指定CSV文件路径
    csv_file_path = f'test_coco_zeroshot_lora_trainset.csv'
