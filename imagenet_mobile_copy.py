...
parser.add_argument("--K", default=100,type=int, help="Number of audio blocks")
...
#embedding path
parameter_embedding_folder='parameters/image/lora/5000/'
lora_dir =f'/home/u2021010261/data/yx/Mobile-Search-Engine-main/.checkpoints/lora/imagenet/step1/{full_layer}'
model_parameter='/home/u2021010261/pc/Mobile-Search-Engine/parameters/model/imagenet32/image_R30.pth'


embedding_folder=f'{parameter_embedding_folder}embeddings_{N}.pth'
embedding_dynamic_folder=f'parameters/dynamic/image/lora_5000/N={N}_S=30.pth'
#save layers
layers_folder=f"parameters/layers/imagenet/lora_5000/N={N}_S=30.pkl"


shortlist_folder=f"parameters/shortlist/imagenet/lora_5000/shortlist_data_{N}_{K}_S=30.pkl"
fine_model_embeddings=f'parameters/image/lora/5000/embeddings_{full_layer}.pth'
embeddings={}
...
# 加载已保存的模型参数
predict_model.load_state_dict(torch.load(model_parameter))
models = []
...
# # 指定CSV文件路径
csv_file_path = 'end_to_end_lora_N_K.csv'
