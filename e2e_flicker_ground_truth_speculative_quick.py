...
all_text_embeddings = torch.load(f'{parameter_embedding_folder}/text_embeddings_{QL}.pth', map_location=torch.device(args.device))['text_embeddings']
...
if os.path.exists(shortlist_path):
    ...
    if show_dynamic_embedding_accuracy:
        ...
        # # 指定CSV文件路径
        csv_file_path = f'ground_truth_lora_{version}_quick.csv'
