...
class SimpleTransformer2(nn.Module):
    def __init__(
        ...
        num_blocks=num_blocks2+num_blocks1
        ...
        self.blocks = nn.Sequential(
            *[
                ...
                # 创建包含前 n 层的 nn.Sequential
        self.blocks_1 = nn.Sequential(*self.blocks[:num_blocks1])
    ...
    def forward(
        ...
        for blk_id, blk in enumerate(self.blocks_1):
