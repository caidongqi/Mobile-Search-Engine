...
with torch.no_grad():
    ...
    test_dl = DataLoader(dataset=CoCo_dataset, batch_size=64, shuffle=False, drop_last=False, num_workers=4, pin_memory=True, persistent_workers=True)
    ...
    }, f'parameters/image/coco/val/text_embeddings_{v_block}_trunk_lora.pth')
