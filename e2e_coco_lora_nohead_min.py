...
parser.add_argument("--version", default='test_coco_nohead_ground_truth_min',type=str, help="gpu device id (if applicable)")
...
text_embeddings_dir = f'{parameter_embedding_folder}/text_embeddings_trunk_lora_{version}.pt'
...
ground_truth='results/coco_lora_val_nohead/R10/layers_min.txt'
