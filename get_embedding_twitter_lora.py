...
parser.add_argument("--lora_layers", default=32,type=int, help="Number of audio blocks")
...
parser.add_argument("--embedding_dir", default='parameters/image/twitter',type=str, help="Number of audio blocks")
parser.add_argument("--version", default='twitter',type=str, help="gpu device id (if applicable)")
...
lora_dir=lora_dir+f'/{lora_layers}'
...
logging.basicConfig(level=logging.INFO,
                    ...
                    datefmt='%Y-%m-%d %H:%M:%S',
                    handlers=[logging.FileHandler(f'logs/embeddings/{version}_{lora_layers}_{formatted_time}.log')], 
                    force=True)
#device = "cuda:0" if torch.cuda.is_available() else "cpu"
...
embedding_dir=f'{embedding_dir}/embeddings_lora_{v_block}.pth'
