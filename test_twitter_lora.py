...
parser.add_argument("--version", type=str, default='twitter-lora', help="version of test lora")
parser.add_argument("--lora_dir", type=str, default='.checkpoints/lora/twitter/with_head/trunk/e50/{vision_num_blocks}', help="lora dir")
...
csv_file_path = f'infer_{version}_lora.csv'
...
embeddings_path=f'{embeddings_path}/embeddings_lora_{vision_num_blocks}.pth'
...
if lora_dir != None:
    model.modality_trunks.update(LoRA.apply_lora_modality_trunks(model.modality_trunks, rank=4,
                                                                    layer_idxs={
                                                                                ModalityType.VISION: [i for i in range(1,32)]},
