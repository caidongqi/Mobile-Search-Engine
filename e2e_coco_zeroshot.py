...
parser.add_argument("--version", default='01',type=str, help="gpu device id (if applicable)")
...
S=args.S
split=args.split
version=args.version # version 1 is wrongly using imagenet's lora
# N=2
# Q=100
...
model_parameter=f'parameters/image/coco/model/image_S={S}_origin.pth'
...
if os.path.exists(shortlist_path):
    ...
    # # 指定CSV文件路径
    csv_file_path = f'e2e_coco_zeroshot.csv'
