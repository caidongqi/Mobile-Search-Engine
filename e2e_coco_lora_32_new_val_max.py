...
parser.add_argument("--version", default='test_coco_ground_truth_max',type=str, help="gpu device id (if applicable)")
...
ground_truth='results/coco_lora_val/R10/layers.txt'
